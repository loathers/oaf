...
export const PATH_MAPPINGS: Map<string, number> = new Map([
  ...
  ["1 crazy random summer", 25],
  ["ocrs", 25],
  ["1crs", 25],
  ["community service", 26],
  ["cs", 26],
  ["hccs", 26],
  ["avatar of west of loathing", 27],
  ["awol", 27],
  ["the source", 28],
  ["source", 28],
  ["nuclear autumn", 29],
  ...
  ["noob", 30],
  ["gnoob", 30],
  ["license to adventure", 31],
  ["lta", 31],
  ["live ascend repeat", 32],
  ["lar", 32],
  ["pocket familiars", 33],
  ["pokefam", 33],
  ["glover", 34],
  ["g lover", 34],
  ["disguises delimit", 35],
  ["dd", 35],
  ["dark gyffte", 36],
  ["dg", 36],
  ["vampire", 36],
  ["vampyre", 36],
  ["two crazy random summer", 37],
  ["2 crazy random summer", 37],
  ["tcrs", 37],
  ["2crs", 37],
  ["kingdom of exploathing", 38],
  ["exploathing", 38],
  ["path of the plumber", 39],
  ["plumber", 39],
  ["mario", 39],
  ["low key summer", 40],
  ["lks", 40],
